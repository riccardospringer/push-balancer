...
def test_monday_uses_the_deterministic_berlin_layout():
    ...
    # Mittagsslot 12:30, Abendbereich (User-Vorgabe 2026-08-04): taeglich
    # 17:30 bis 22:45, fuenf Slots mit maximalem Abstand.
    assert labels == {
        "06:00", "06:36", "07:12", "07:47", "08:23", "08:59",
        "12:30",
        "17:30", "18:49", "20:08", "21:26", "22:45",
    }
    # Ruhezeit ab 23:00; die Totzone 10/11 bleibt draussen.
...
def test_every_weekday_uses_the_deterministic_layout_and_reaches_11_to_15(
    ...
    # Abendbereich (User-Vorgabe 2026-08-04): taeglich fuenf fixe Slots
    # 17:30 bis 22:45, maximal gespreizt — wochentagsunabhaengig.
