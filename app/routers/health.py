...
def get_health() -> JSONResponse:
    ...
    cost_controls = {
        ...
        "openaiReaderScoreEnabled": bool(
            OPENAI_READER_SCORE_ENABLED
            and OPENAI_READER_SCORE_MAX_CALLS_PER_HOUR > 0
            and OPENAI_READER_SCORE_MAX_CALLS_PER_DAY > 0
        ),
        "openaiReaderScoreModel": OPENAI_READER_SCORE_MODEL if OPENAI_READER_SCORE_ENABLED else "",
