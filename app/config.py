...
PUSH_TEAMS_MIN_ALERT_SCORE: float = _env_float("PUSH_TEAMS_MIN_ALERT_SCORE", 78.0)
...
PUSH_TEAMS_MIN_EDITORIAL_SCORE: float = _env_float("PUSH_TEAMS_MIN_EDITORIAL_SCORE", 82.0)
